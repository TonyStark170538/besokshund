export const dogs = [
  {
    ...
    accentColor: "#F5F1ED",
    funFacts: [
      "Elvis älskar att leka apport och blir aldrig trött",
      "Han har en otrolig känsla för humor och gör folk skrattande",
      "Hans favoritaktivitet är att läsa stödsessioner med barn",
      "Elvis kan lära sig nya tricker på bara några försök"
    ],
    emotionalStrengths: [
      "Bygger självförtroende genom lekfull interaktion",
      "Uppmuntrar aktivt deltagande och engagemang",
      "Skapar glädjefyllda minnen och positiva associationer",
      "Hjälper barn att känna sig förstådda och värderade"
    ]
  },
  {
    id: "sunny",
    ...
    accentColor: "#D4A574",
    funFacts: [
      "Sunny har en intuitiv känsla för när någon behöver tröst",
      "Hon älskar mjuka kramar och tyst sällskap",
      "Hennes favoritplats är att liggande bredvid någon som behöver stöd",
      "Sunny har hjälpt otaliga äldre att känna sig mindre ensamma"
    ],
    emotionalStrengths: [
      "Ger ovillkorlig tröst och emotionellt stöd",
      "Minskar stress och ångest genom lugn närvaro",
      "Skapar meningsfulla kopplingar med äldre individer",
      "Förmedlar fred och stillhet i varje interaktion"
    ]
  },
  {
    id: "ringo",
    ...
    accentColor: "#C9A876",
    funFacts: [
      "Ringo är den mest erfarna besökshunden i teamet",
      "Han kan läsa en rum och justera sin energi därefter",
      "Ringo älskar att arbeta med alla åldersgrupper",
      "Hans lugna självförtroende och inkännande personlighetinspirerar till förtroende hos alla han möter"
    ],
    emotionalStrengths: [
      "Ger balanserat stöd för olika emotionella behov",
      "Förmedlar visdom och stabilitet i komplexa situationer",
      "Skapar kopplingar med människor av alla åldrar och bakgrunder",
      "Skapar säkra utrymmen genom lugn, självsäker närvaro"
    ]
  }
];
...
export const faqs = [
  ...
  },
  {
    ...
    answer: "Absolut. Våra besökshundar är noggrant utvalda, utförligt utbildade och temperamentstestade för att arbeta säkert med människor i alla åldrar. De är vänliga, tålmodiga och lyhörda för individuella behov."
  },
  {
    question: "Kan jag begära en specifik hund för min session?",
    answer: "Vi försöker tillgodose alla preferenser, men valet av hund baseras på individens behov och hundens nuvarande tillgänglighet. Marie kommer att se till att den bästa matchningen passar din situation."
  },
  {
